...
if(isset($_SESSION['UltimaAcao'])){
  ...
  $selecionar = "SELECT * FROM `EmpresaBancos` WHERE Nome LIKE '%$Nome%' and `CNPJBanco` LIKE '$CNPJBanco'";
  ...
  if(isset($row['Nome'])){
    ...
    $Nome = $row['Nome'];
    $CNPJBanco = $row['CNPJBanco'];
    $Tarifa = "R$ " . $row['Tarifa'];
    $ComissaoBanco = "% " . number_format(($row['ComissaoBanco']*100), '2', ',');
    $Status = $row['Status'];

  }else{

    $_SESSION['UltimaAcao'] = 'Não foi Possível Selecionar os Dados';
    header('Location: SelecionarBanco.php');
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                  ...
                  <h1 class="mb-0 pb-0 display-5" id="title">Editar Banco</h1>
                  <a href="SelecionarBanco.php" class="muted-link pb-1 d-inline-block breadcrumb-back">
                    <i data-acorn-icon="chevron-left" data-acorn-size="13"></i>
                    <span class="text-medium align-middle">Voltar a Seleção de Bancos</span>
                  </a>
                </div>
              </div>
              <!-- Title End -->
          ...
          <div class="row">
            <div class="col-12 col-xl-9 col-lg order-1 order-lg-0">
                ...
                <form action="UpdateBanco.php" method="post" id="addressForm" class="tooltip-label-end">
                  ...
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <div class="col-md-4 mb-3 filled">
                        ...
                        <input class="form-control" name="Nome" placeholder="Nome do Banco" value="<?php echo $Nome ?>">
                      </div>
                      

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="credit-card"></i>
                        <input class="form-control" name="CNPJBanco" placeholder="CNPJ do Banco" value="<?php echo $CNPJBanco ?>">
                      </div>
                ...
                <div class="card-body mb-n5">
                  <div class="row g-3">
                      ...
                      <div class="mb-2">
                        ...
                        <input type="text" name="Tarifa" class="form-control mask-currency" id="Tarifa" onKeyUp="mascaraMoedaReal(this, event)" value="<?php echo $Tarifa ?>">
                      </div>

                      <div class="mb-2">
                        <label class="form-label">Repasse</label>
                        <input type="text" name="ComissaoBanco" class="form-control mask-currency" id="ComissaoBanco" onKeyUp="mascaraPorcentagem(this, event)" value="<?php echo $ComissaoBanco ?>">
                      </div>
                  ...
                  <div class="d-flex justify-content-center">
                    <div class="d-flex flex-column flex-sm-row justify-content-between mb-5 w-100">
                      <input class="btn btn-icon btn-icon-end btn-primary w-100" type="submit" value="Editar Banco">
                    </div>
                    </form>
                  </div>
                </div>
              ...
              <div class="col-sm-6 d-none d-sm-block">
                <ul class="breadcrumb pt-0 pe-0 mb-0 float-end">
                  <li class="breadcrumb-item mb-0 text-medium">
                    <a href="3" target="_blank" class="btn-link">Link 1</a>
                  </li>
                  <li class="breadcrumb-item mb-0 text-medium">
