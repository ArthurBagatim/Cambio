...
// Barra de Buscar
include('DadosSelecionarOperacao.php');
...
if(isset($_SESSION['EditarBuscar'])){

  $EditarBuscaDisplay = 'block';

}else{

  $EditarBuscaDisplay = 'none';
...
<html lang="pt-BR" data-footer="true">
  <head>
    ...
    <title>Selecionar operação - Empresa</title>
    <meta name="description" content="Página para selecionar operações" />
    <!-- Favicon Tags Start -->
...
<html data-override='{"attributes": {"color": "dark-green" }}'>
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-40">
                  ...
                  <h1 class="mb-0 pb-0 display-5" id="title">Listagem de operações</h1>
                </div>
              </div>
              <!-- Title End -->
            </div>
  ...
  <!-- listagem de resultados START -->
                <div class="col-12 mb-5">
                  <section class="scroll-section" id="sortAndFilterTitle">
                    <h2 class="small-title">Resultados de Busca</h2>
                    <div class="row g-2" id="sortAndFilter">
                      <div class="col-12">
                        <div style="display: none;" class="row gx-2">
                                ...
                                <div class="dropdown-menu sw-25 shadow dropdown-menu-end">
                                  <div class="px-4 py-3">
                                    <div class="form-check mb-2">
                                      <input type="checkbox" class="form-check-input filter" id="category1" data-filter="Multigrain" checked />
                                      <label class="form-check-label" for="category1">Multigrain</label>
                                    </div>
                                    <div class="form-check mb-2">
                                      <input type="checkbox" class="form-check-input filter" id="category2" data-filter="Sourdough" checked />
                                      <label class="form-check-label" for="category2">Sourdough</label>
                                    </div>
                                    <div class="form-check">
                                      <input type="checkbox" class="form-check-input filter" id="category3" data-filter="Whole Wheat" checked />
...
<!-- títulos das colunas na tabela de resultados START -->
                      <div style='display: <?php echo $EditarBusca ?>;' class="col-12">
                        <div class="card">
                          <div class="card-body">
                            <div class="row g-0 h-100 align-content-center mb-2 custom-sort d-none d-sm-flex">
                              <div class="col-12 col-sm-3 d-flex align-items-center">
                                <div class="text-muted text-MEDIUM cursor-pointer sort" data-sort="name">CLIENTE</div>
                              </div>
                              <div class="col-12 col-sm-2 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="category">COMPRA/VENDA</div>
                              </div>
                              <div class="col-12 col-sm-2 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="sale">MOEDA</div>
                              </div>
                              
                              <div class="col-12 col-sm-2 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="sale">Valor (US$)</div>
                              </div>

                                
                              <div class="col-12 col-sm-1 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="sale">Taxa final</div>           
                              </div>
                              <div class="col-12 col-sm-2 d-flex  justify-content-sm-end">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="sale">Ação</div>                              
                              </div>


                            </div>                    
                                      
                          <!-- títulos das colunas na tabela de resultados END -->

                              <!-- linhas de ressultados da tabela de resultados START -->
                                <?php echo $ResultadosdaBusca ?>
                              <!-- linhas de ressultados da tabela de resultados START -->
            ...
            <div class="col-12 col-xl-3 mb-n5 col-lg-auto order-0 order-lg-1">
              ...
              <!-- Summary Start --><br><br>
              <h2 class="small-title">Filtros de busca</h2>
              <div class="card mb-5 w-100  ">
                <div class="card-body mb-n5">
                  <div class="row g-3">

                     <form action="SelecionarOperacao.php" method="post">

                       <div class="mb-3 filled">
                          <i data-acorn-icon="calendar"></i>
                          <input type="text" class="data form-control" name="Data" placeholder="Data da operação"/>
                        </div>

                      <div class="mb-2">
                        <label class="form-label">Busque pelo cliente</label>
                        <input type="text" class="form-control" name="Cliente" placeholder="Nome do cliente" required/>
                      </div>


                      <div style="display: none;" class="mb-2">
                        <label class="form-label">Busque pelo documento</label>
                        <input type="text" class="form-control" name="CNPJ_CPF" placeholder="CNPJ ou CPF do cliente"/>
                      </div>

                      <div class="mb-2">
                        <label class="form-label">Operador responsável</label>
                        <input type="text" class="form-control mask-currency" name="OperadorResponsavel" placeholder="Gabriel Maciel" />
                      </div>

                      <div class="mb-2">
                        <label class="form-label">Compra/Venda</label>
                        <input type="text" class="form-control mask-currency" name="TipoDeOperacao" placeholder="Compra" />
                      </div>

                      <div class="mb-2">
                        <label class="form-label">ID do Contrato</label>
                        <input type="text" class="form-control mask-currency" name="IDdoContrato" placeholder="ID do Contrato" />
                      </div><br>

                        
                      <div class="d-flex flex-column flex-sm-row justify-content-between mb-5 w-100">
                        <input class="btn btn-icon btn-icon-end btn-primary w-100" type="submit" value="Procurar">
                      </div>
