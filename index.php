...
if(isset($_SESSION['Usuario']) && isset($_SESSION['Senha']) || isset($_SESSION['Error'])){
            ...
            <div class="form-holder">
                <div class="form-content">
                    <div class="form-items">
                        <h3>Registros de Operações</h3>
                        <p>Acesso restrito ao sistema de registro de operações e clientes.</p>
                        <form action="Verificacao.php" method="post">
                            <input class="form-control" type="e-mail" name="Usuario" placeholder="Seu e-mail Empresa" required>
                            <input class="form-control" type="password" name="Senha" placeholder="Sua Senha" required>
                            <div class="form-button">
                                <button id="submit" type="submit" class="ibtn">Entrar</button> <a href="forget.php">Esqueci a Senha</a>
                            </div>
                        </form>
