...
if(isset($_SESSION['UltimaAcao'])){
  ...
  $PFPJ = $_SESSION['PFPJ'];
  $CNPJ_CPF = $_SESSION['CNPJ_CPF'];
  $ResponsavelPelaOperacao = $_SESSION['ResponsavelPelaOperacao'];
  $Estado = $_SESSION['Estado'];
  $Cidade = $_SESSION['Cidade'];
  $Cep = $_SESSION['Cep'];
  $Endereco = $_SESSION['Endereco'];
  $SetordeAtuacao = $_SESSION['SetordeAtuacao'];
  $Banco = $_SESSION['Banco'];
  $BancoCNPJ = $_SESSION['BancoCNPJ'];
  $TarifaBanco = $_SESSION['TarifaBanco'];
  $NumerodaConta = $_SESSION['NumerodaConta'];
  $Banco_2 = $_SESSION['Banco_2'];
  $BancoCNPJ_2 = $_SESSION['BancoCNPJ_2'];
  $TarifaBanco_2 = $_SESSION['TarifaBanco_2'];
  $NumerodaContaBanco_2 = $_SESSION['NumerodaContaBanco_2'];
  $Natureza = $_SESSION['Natureza'];
  $TipoDeOperacao = $_SESSION['TipoDeOperacao'];
  $ComissaoBanco = $_SESSION['ComissaoBanco'];
  ...
  unset($_SESSION['PFPJ']);
  unset($_SESSION['CNPJ_CPF']);
  unset($_SESSION['ResponsavelPelaOperacao']);
  unset($_SESSION['Estado']);
  unset($_SESSION['Cidade']);
  unset($_SESSION['Cep']);
  unset($_SESSION['Endereco']);
  unset($_SESSION['SetordeAtuacao']);
  unset($_SESSION['Banco']);
  unset($_SESSION['BancoCNPJ']);
  unset($_SESSION['TarifaBanco']);
  unset($_SESSION['NumerodaConta']);
  unset($_SESSION['Banco_2']);
  unset($_SESSION['BancoCNPJ_2']);
  unset($_SESSION['TarifaBanco_2']);
  unset($_SESSION['NumerodaContaBanco_2']);
  ...
  $TarifaBanco = 'R$';
  $NumerodaConta = '';
  $Banco_2 = 'Banco Secundario';
  $BancoCNPJ_2 = '';
  $TarifaBanco_2 = 'R$';
  $NumerodaContaBanco_2 = '';
...
<html lang="pt-BR" data-footer="true">
  <head>
    ...
    <title>Registro de clientes - Empresa</title>
    <meta name="description" content="Página de registro de clientes" />
    <!-- Favicon Tags Start -->
...
<html data-override='{"attributes": {"color": "dark-green" }}'>
   <body class="" data-bs-padding="22px"><div id="paddingModal" class="modal" aria-hidden="true" style="display: none;"> <div class="modal-dialog d-none"><div class="modal-content"></div></div> </div>
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                  ...
                  <h1 class="mb-0 pb-0 display-5" id="title">Registrar Cliente</h1>
                </div>
              </div>
              <!-- Title End -->
            </div>
          ...
          <div class="row">
            <div class="col-12 col-xl-9 col-lg order-1 order-lg-0">
              ...
              <form action="InserirCliente.php" method="post" id="addressForm" class="tooltip-label-end">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="row g-3">
                      <div class="col-md-4 mb-3 filled">
                        <i data-acorn-icon="building"></i>
                        <input class="form-control" name="Cliente" placeholder="Nome do cliente" value="<?php echo $Cliente ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="credit-card"></i>
                        <input class="form-control" name="CNPJ_CPF" placeholder="CNPJ/CPF do cliente" value="<?php echo $CNPJ_CPF ?>">
                      </div>

                      <div class="col-md-2 mb-3 filled">
                        <i data-acorn-icon="credit-card"></i>
                        <input class="form-control" name="PFPJ" placeholder="PF/PJ" value="<?php echo $PFPJ ?>">
                      </div>

                       <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="user"></i>
                        <input class="form-control" name="ResponsavelPelaOperacao" placeholder="Funcionario do cliente" value="<?php echo $ResponsavelPelaOperacao ?>">
                      </div>

                      <div class="col-md-4 mb-3 filled">
                        <i data-acorn-icon="user"></i>
                        <input class="form-control" name="Comercial" placeholder="Comercial responsável" value="<?php echo $Comercial ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="category"></i>
                        <input class="form-control" name="Equipe" placeholder="Equipe" value="<?php echo $Equipe ?>">
                      </div>

                      <div class="col-md-2 mb-3 filled">
                        <i data-acorn-icon="credit-card"></i>
                        <input class="form-control" name="ComissaoBanco" id="ComissaoBanco" value="<?php echo $ComissaoBanco; ?>" readonly>
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="phone"></i>
                        <input class="form-control" name="Telefone" placeholder="Telefone" value="<?php echo $Telefone ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="message"></i>
                        <input class="form-control" name="Whatsapp" placeholder="Whatsapp" value="<?php echo $Whatsapp ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="globe"></i>
                        <input class="form-control" name="Estado" placeholder="Estado" value="<?php echo $Estado ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="building-large"></i>
                        <input class="form-control" name="Cidade" placeholder="Cidade" value="<?php echo $Cidade ?>">
                      </div>

                      <div class="col-md-4 mb-3 filled">
                        <i data-acorn-icon="pin"></i>
                        <input class="form-control" name="Endereco" placeholder="Endereço" value="<?php echo $Endereco ?>">
                      </div>

                      <div class="col-md-2 mb-3 filled">
                        <i data-acorn-icon="pin"></i>
                        <input class="form-control" name="Cep" placeholder="CEP" value="<?php echo $Cep ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="category"></i>
                        <input class="form-control" name="SetordeAtuacao" placeholder="Setor de atuação" value="<?php echo $SetordeAtuacao ?>">
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="category"></i>
                        <input class="form-control" name="Site" placeholder="Site" value="<?php echo $Site ?>">
                      </div>
                      ...
                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="category"></i>
                        <input class="form-control" name="Observacoes" placeholder="Observações" value="<?php echo $Observacoes ?>">
                      </div>
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <div class="col-md-4 mb-3 filled">
                        <i data-acorn-icon="money-bag"></i>
                        <?php echo $BancoDados_2 ?>
                      </div>

                      <div class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="credit-card"></i>
                        <input class="form-control" name="BancoCNPJ_2" id="BancoCNPJ_2" value="<?php echo $BancoCNPJ_2; ?>" readonly>
                      </div>

                      <div class="col-md-3 mb-3 filled">
                      <i data-acorn-icon="wallet"></i>
                      <input class="form-control" name="NumerodaContaBanco_2" placeholder="Nº da conta Banco secundario" value="<?php echo $NumerodaContaBanco_2 ?>">
                      </div>
            ...
            <div class="col-12 col-xl-3 mb-n5 col-lg-auto order-0 order-lg-1">
              ...
              <!-- Summary Start -->
              <h2 class="small-title">Valores Padrões</h2>
                ...
                <div class="card-body mb-n5">
                  <div class="row g-3">
                      ...
                      <div class="mb-2">
                        ...
                        <input type="text" name="TarifaBanco" class="form-control mask-currency" id="TarifaBanco" onKeyUp="mascaraMoedaReal(this, event)" value="<?php echo $TarifaBanco ?>" required>
                      </div>

                      <div class="mb-2">
                        <label class="form-label">Tarifa do banco</label>
                        <input type="text" name="TarifaBanco_2" class="form-control mask-currency" id="TarifaBanco_2" onKeyUp="mascaraMoedaReal(this, event)" value="<?php echo $TarifaBanco_2 ?>" required>
                      </div>
                  ...
                  <div class="form-check mb-4">
                    ...
                    <label class="form-check-label" for="customCheck1">
                      ...
                      <a href="#" target="_blank">dados do Cliente.</a>
                    </label>
                  </div>
                  <div class="d-flex justify-content-center">
                    <div class="d-flex flex-column flex-sm-row justify-content-between mb-5 w-100">
                      <input class="btn btn-icon btn-icon-end btn-primary w-100" type="submit" value="Registrar Cliente">
                    </div>
                    </form>
                  </div>
                </div>
    ...
    <script src="RegistrarClientes.js"></script>
