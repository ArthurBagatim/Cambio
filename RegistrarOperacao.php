...
// Cliente Dados Para Registrar
include('DadosRegistrarOperacao.php');
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                  ...
                  <h1 class="mb-0 pb-0 display-5" id="title">Registrar operação</h1>
                </div>
              </div>
              <!-- Title End -->
            </div>
          ...
          <div class="row">
            <div class="col-12 col-xl-9 col-lg order-1 order-lg-0">
              ...
              <form action="InserirOperacao.php" method="post" id="addressForm" class="tooltip-label-end" enctype="multipart/form-data">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <div style="display: none;" class="col-md-3 mb-3 filled">
                        <i data-acorn-icon="credit-card"></i>
                        <input class="form-control" name="CNPJ_CPF" placeholder="CNPJ/CPF cliente" value="<?php echo $CNPJ_CPF; ?>" readonly>
                      </div>
                      ...
                      <div class="col-md-2 mb-3 filled">
                       ...
                       <div class="col-md-3 mb-3 filled">
                        ...
                        <input class="form-control" name="ResponsavelPelaOperacao" placeholder="Funcionario cliente" value="<?php echo $ResponsavelPelaOperacao; ?>" readonly>
                      </div>
                  ...
                  <div class="card-body">
                    <div class="row g-3">
                      ...
                      <div class="col-md-3 mb-3 filled">
                        ...
                        <input class="form-control" name="NumerodaConta" placeholder="Nº conta" value="<?php echo $NumerodaConta; ?>">
                      </div>
                      ...
                      <div class="col-md-3 mb-3 filled">
                      <i data-acorn-icon="category"></i>
                        <input class="form-control" name="IDdoContrato" placeholder="Nº do Contrato" value="<?php echo $IDdoContrato ?>">
                      </div>
                ...
                <div class="card-body mb-n5">
                  <div class="row g-3">
                      ...
                      <div class="mb-2">
                        ...
                        <input type="file" name="arquivo" accept=".pdf" value="<?php echo $_SESSION['Arquivo'] ?>">
                      </div>
                      ...
                      <div class="mb-2">
                        ...
                        <input type="text" name="TarifaBanco" class="form-control mask-currency" id="TarifaBanco" onKeyUp="mascaraMoedaReal(this, event) + FuncaoReceitaBruta()" value="<?php echo $TarifaBanco ?>" required>
                      </div>

                      <div class="mb-2">
                        <label class="form-label">Tarifa cobrada</label>
                        <input type="text" name="TarifaCobrada" class="form-control mask-currency" id="TarifaCobrada" onKeyUp="mascaraMoedaReal(this, event) + FuncaoReceitaBruta()" value="<?php echo $TarifaCobrada ?>" required>
                      </div>
                  ...
                  <div class="d-flex justify-content-center">
                    <div class="d-flex flex-column flex-sm-row justify-content-between mb-5 w-100">
                      <input class="btn btn-icon btn-icon-end btn-primary w-100" type="submit" value="Registrar operação">
                    </div>
                    </form>
                  </div>
                </div>
