...
// Barra de Buscar
include('DadosSelecionarBanco.php');
...
<html lang="pt-BR" data-footer="true">
  <head>
    ...
    <title>Registro de banco - Empresa</title>
                          ...
                          <div class="card-body">
                            <div class="row g-0 h-100 align-content-center mb-2 custom-sort d-none d-sm-flex">
                              <div class="col-12 col-sm-3 d-flex align-items-center">
                                <div class="text-muted text-MEDIUM cursor-pointer sort" data-sort="name">Banco</div>
                              </div>
                              <div class="col-12 col-sm-3 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="category">CNPJ</div>
                              </div>
                              <div class="col-12 col-sm-2 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="sale">TARIFA</div>
                              </div>
                              
                              <div class="col-12 col-sm-2 d-flex align-items-center">
                                <div class="text-muted text-medium cursor-pointer sort" data-sort="sale">COMISSÃO</div>
              ...
              <div class="card mb-5 w-100  ">
                <div class="card-body mb-n5">
                  <div class="row g-3">
                     ...
                     <form action="SelecionarBanco.php" method="post">

                      <div class="mb-2">
                        <label class="form-label">Nome do Banco</label>
                        <input type="text" class="form-control" name="Nome" placeholder="CNPJ do Banco"/>
                      </div>

                      <div class="mb-2">
                        <label class="form-label">CNPJ do Banco</label>
                        <input type="text" class="form-control mask-currency" name="CNPJBanco" placeholder="CNPJ do Banco" />
                      </div>
