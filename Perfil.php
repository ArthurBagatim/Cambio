...
// Criando Variável Para Cada Cliente JS
echo "
<script>

var BuscarNomeDoCliente = [];
var BuscarCNPJ_CPF = [];
var BuscarNumerodeClientes = '$x';
...
while($x > 0){
  ...
  $BuscarCNPJ_CPF[$x] = $_SESSION['BuscarCNPJ_CPF'][$x];
    ...
    // Script Para Tornar Clientes em Variáveis JS
  echo "
  <script>

  BuscarNomeDoCliente[$x] = '$BuscarNomeDoCliente[$x]';
  BuscarCNPJ_CPF[$x] = '$BuscarCNPJ_CPF[$x]';
...
// Verificando se Foi Selecionado um Cliente
if(isset($_POST['BuscarCNPJ_CPF'])){

  $_SESSION['CNPJ_CPF'] = $_POST['BuscarCNPJ_CPF'];

}

if(isset($_SESSION['CNPJ_CPF'])){
  ...
  if(isset($row['CNPJ_CPF'])){
    ...
    $TarifadoBanco = $row['TarifadoBanco'];
    ...
    $_SESSION['Erro'] = 'Erro, Tente Novamente ou Chame um Administrador';
  ...
  // Definindo Inicio de Rows Para Ultimas Operações do Cliente
  $x = 1;
...
<html lang="pt-BR" data-footer="true">
  <head>
    ...
    <title>Perfil Cliente - Empresa</title>
    <meta name="description" content="Página do perfil do cliente"/>
    <!-- Favicon Tags Start -->
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                  ...
                  <h1 class="mb-0 pb-0 display-5" id="title">Dados do Perfil</h1>
                </div>
              </div>
              <!-- Title End -->
            </div>
          ...
          <div class="row">
            <div class="col-12 col-xl-9 col-lg order-1 order-lg-0">
              <h2 class="small-title">Atualizar Perfil</h2>
              <form action="AtualizarDados.php" method="post" enctype=”multipart/form-data”>
                <input name="Foto" type="file" accept="image/*" required><br><br>
