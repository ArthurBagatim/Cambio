...
if(isset($_SESSION['UltimaAcao'])){
  ...
  $Comissao = $_SESSION['Comissao']*100;
...
}else if(isset($_POST['BuscarNomeDoCliente'])){
  ...
  $_SESSION['UltimaAcao'] = 'Não Há Dados';
  header('Location: Dashboard.php');
...
<html lang="pt-BR" data-footer="true">
  <head>
    ...
    <title>Atualizar Cliente - Empresa</title>
    <meta name="description" content="Página para atualização de dados do cliente" />
    <!-- Favicon Tags Start -->
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-auto mb-3 mb-md-0 me-auto">
                <div class="w-auto sw-md-30">
                  ...
                  <h1 class="mb-0 pb-0 display-5" id="title">Atualizar Cliente</h1>
                </div>
              </div>
              <!-- Title End -->
            </div>
          ...
          <div class="row">
            <div class="col-12 col-xl-9 col-lg order-1 order-lg-0">
              ...
              <form action="UpdateCliente.php" method="post" id="addressForm" class="tooltip-label-end">
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="row g-3">
                ...
                <div class="card-body mb-n5">
                  ...
                  <div class="d-flex justify-content-center">
                    <div class="d-flex flex-column flex-sm-row justify-content-between mb-5 w-100">
                      <input class="btn btn-icon btn-icon-end btn-primary w-100" type="submit" value="Atualizar Cliente">
                    </div>
                    </form>
                  </div>
                </div>
